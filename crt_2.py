...
def f2(x, r0, r2, c1, c2, n, a, t, phi):
    return ((2 / ((r0 + x * (r2 - r0)))) * ((r2 * c2 * ((-1) ** n)) - r0 * c1) * (n * torch.pi) * (
        np.exp(-(((n ** 2) * (torch.pi ** 2) + phi ** 2) * a * t))) * np.sin(n * torch.pi * x)) / (
                (n ** 2) * (torch.pi ** 2) + phi ** 2)
            ...
            for w in weights:
                for tim in times:
                    ...
                    for j in range(5):
                        ...
                        np.savetxt(
                            "data_" + str(radius0) + "_" + str(radius2) + "_" + str(w) + '_' + str(j + 1) + '_' + str(
                        ...
                        plt.legend()
                        plt.savefig(
                            'lambda_' + str(radius0) + "_" + str(radius2) + '_' + str(w) + '_' + str(j + 1) + '_' + str(
                                tim) + '.png')
